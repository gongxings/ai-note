...
<template>
  ...
  >
    ...
    <div class="mx-auto max-w-screen-2xl flex flex-1 items-center justify-between px-4">
      ...
      <div>
        <slot name="title">
          <NuxtLink to="/" class="text-primary-500 text-lg font-bold">
            <Icon
    ...
    >
      <AwesomeActionSheetGroup>
        ...
        <AwesomeActionSheetItem class="flex flex-col">
          <div class="pb-2">
            <div class="mb-2 mt-2 text-sm font-bold capitalize">Change Theme</div>
            <LayoutPageNavbarDropdownThemeSwitcher type="select-box" />
          </div>
        </AwesomeActionSheetItem>
      </AwesomeActionSheetGroup>
      <AwesomeActionSheetGroup>
        <AwesomeActionSheetItemButton class="flex items-center justify-center text-base space-x-2">
